  ...
  return (
    <AbsoluteFill data-structure-identity="semantic-doodle" data-critical-content="true" style={typography}>
      <FullScreenSurface mode="opaque" palette={palette}>
        <div style={{position: 'absolute', left: '6%', top: '16%', width: '29%', padding: '30px 28px', borderRadius: 28, background: palette.surface, border: `2px solid ${palette.line}88`, boxShadow: `0 25px 70px ${palette.canvas}99`, ...rise(phase(progress, 0, .44), 24)}}>
        ...
        <div data-integrated-doodle="true" style={{position: 'absolute', left: '39%', right: '6%', top: '10%', bottom: '10%', padding: '20px 18px 12px', borderRadius: 30, background: `linear-gradient(135deg, ${palette.card}, ${palette.surface})`, border: `1px solid ${palette.line}77`, overflow: 'hidden'}}>
