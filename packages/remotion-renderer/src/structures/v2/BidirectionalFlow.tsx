  ...
  return (
    <AbsoluteFill data-structure-identity="bidirectional-flow" data-critical-content="true" style={typography}>
      <FullScreenSurface mode="opaque" palette={palette}>
        ...
        <section style={{position: 'absolute', left: '7%', top: '27%', width: '27%', padding: '30px 28px', borderRadius: 28, background: palette.surface, border: `2px solid ${palette.line}88`, ...rise(forward, 22)}}>
        ...
        <section style={{position: 'absolute', right: '7%', top: '27%', width: '27%', padding: '30px 28px', borderRadius: 28, background: palette.card, border: `2px solid ${palette.accent}88`, ...rise(backward, 22)}}>
          ...
          <div style={{marginTop: 24, padding: 15, borderRadius: 14, background: palette.accent, color: palette.canvas, fontSize: 22, fontWeight: 900}}>{content.result}</div>
        </section>
      </FullScreenSurface>
    </AbsoluteFill>
  );
